...
export const INSTRUMENTS = [
  ...
  },
  {
    ...
    items: [
      { ref: "3.1", q: "Facility type and support status", kind: "radio", opts: ["PHC", "SHC", "Supported", "Non-supported"] },
      ...
      { ref: "3.4", q: "Who compiles the monthly report?", kind: "radio", opts: ["OIC", "M&E", "CHW", "Other"] },
