...
export const GROUPS = [
  { level: "States", note: "Completed at state level.", ids: ["1", "5", "7", "8", "9"] },
  { level: "LGA", note: "Completed at LGA level.", ids: ["2", "7", "9"] },
  { level: "Facilities", note: "Completed at facility level (Instrument 6 for FCV / insecure areas).", ids: ["3", "4", "6", "9"] },
];
