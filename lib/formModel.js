...
const SECTIONS = [
  {id:"A", title:"Policy and Governance", type:"qa", items:[
    ...
    ["What policies support domestic financing for health?", T],
  ...
  {id:"B", title:"Government Budget Commitment", type:"qa", items:[
    ...
    ["What percentage has been released during the last three years?", T],
    ["Which health programmes receive direct state funding?", T],
    ...
    ["How predictable are government releases?", T],
    ["What are the major constraints to budget execution?", T],
  ...
  {id:"D", title:"Health Insurance", type:"qa",
    ...
    ["Which benefit packages include chronic disease management?", T],
    ["What opportunities exist to integrate HIV services?", T],
    ["Are facilities receiving reimbursements on time?", B],
    ["What reforms are planned?", T],
  ]},
  {id:"E", title:"BHCPF", type:"qa", items:[
    ["Is the state implementing BHCPF?", B],
    ["How many facilities benefit?", T],
    ["Which services are financed?", T],
    ...
    ["What are implementation bottlenecks?", T],
  ...
  {id:"F", title:"Donor Dependence", type:"qa", items:[
    ["Which programmes remain donor-dependent?", T],
    ...
    ["Which health system functions depend on donors?", T],
    ["Which positions are donor-funded?", T],
    ["Which commodities are donor-funded?", T],
    ["Which laboratories are donor-supported?", T],
    ["What activities would stop if donor funding ceased?", T],
    ["Which functions can government immediately assume?", T],
  ]},
  {id:"G", title:"Resource Mobilization", type:"qa", items:[
    ...
    ["Which financing opportunities remain untapped?", T],
  ]},
  {id:"H", title:"Financial Management", type:"qa", items:[
    ...
    ["What improvements are needed?", T],
  ]},
  {id:"I", title:"Sustainability and Transition Readiness", type:"qa", items:[
    ["Which donor-supported activities can government immediately absorb?", T],
    ["Which activities require phased transition?", T],
    ["Which require continued donor investment?", T],
    ["Which institutions require capacity strengthening?", T],
    ["Which financing mechanisms should be expanded?", T],
    ["Which policies require revision?", T],
    ["What financing milestones should be achieved over the next five years?", T],
    ["What transition risks exist?", T],
    ["What mitigation measures are proposed?", T],
    ["How will sustainability be monitored?", T],
  ]},
